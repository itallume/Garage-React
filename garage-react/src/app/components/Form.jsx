          ...
          <div className="justify-center items-center pt-[30px]">
            <form className="flex justify-center flex-col bg-gray-900 px-8 py-8 rounded-lg border-white rounded-sm" id="borda1">
              ...
              <div class="flex justify-center pt-[25px]">
                ...
                <input type="button" value="Salvar" name="btn" id="button" class=" text-white p-2 rounded-lg active:bg-[#00ff0059] hover:cursor-pointer"></input>
                <input type="button" value="Fechar" name="btn" id="buttonf" class=" text-white p-2 rounded-lg active:bg-[#00ff0059] hover:cursor-pointer"></input> 
              </div>
            </form>
        </div>
      </section>
